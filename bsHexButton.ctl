VERSION 5.00
Begin VB.UserControl bsHexButton 
   AutoRedraw      =   -1  'True
...
Private Sub DrawButton(Pressed As Boolean)
   ...
   With MyButton
      ...
      Call SetRect(.BottomLeft, 0, Gap, Gap, _
          UserControl.ScaleHeight)
      Call SetRect(.TopRight, UserControl.ScaleWidth - Gap, _
          0, UserControl.ScaleWidth, Gap)
      Call SetRect(.BottomRight, UserControl.ScaleWidth - Gap, _
         Gap, UserControl.ScaleWidth, UserControl.ScaleHeight)
...
Icon:
      ...
      With MyButton
         ...
         picFace.Line (.BottomLeft.Left, .BottomLeft.Top)-(.BottomLeft.Right + 1, .BottomLeft.Bottom)
         picFace.Line (.TopLeft.Right - 1, .TopLeft.Top)-(.TopRight.Left, .TopRight.Top)
         picFace.Line (.TopRight.Left + 1, .TopRight.Top)-(.TopRight.Right, .TopRight.Bottom)
...
Private Sub DrawPressedEdges()
   ...
   With MyButton
      ...
      Line (.BottomLeft.Left, .BottomLeft.Top)-(.BottomLeft.Right, .BottomLeft.Bottom - 1)
      ...
      End If
      Line (.TopRight.Left + 1, .TopRight.Top)-(.TopRight.Right, .TopRight.Bottom)
      ...
      Line (.BottomLeft.Left + 1, .BottomLeft.Top)-(.BottomLeft.Right, .BottomLeft.Bottom - 2)
      Line (.TopLeft.Right - 1, .TopLeft.Top + 1)-(.TopRight.Left, .TopRight.Top + 1)
      ForeColor = m_HighlightDKColour
      Line (.TopRight.Left, .TopRight.Top)-(.TopRight.Right - 1, .TopRight.Bottom)
...
Private Sub DrawEdges()
   ...
   With MyButton
      ...
      End If
      Line (.TopLeft.Left, .TopLeft.Bottom - 1)-(.TopLeft.Right - 1, .TopLeft.Top)
      Line (.TopLeft.Right - 1, .TopLeft.Top)-(.TopRight.Left + 1, .TopRight.Top)
